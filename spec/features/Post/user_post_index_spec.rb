...
RSpec.feature 'User Post Index Page' do
  let!(:user) { User.create(name: 'user1', bio: 'this is test bio', email: 'abc@gmail.com', password: 123_456, photo: 'https://instasize.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fmunkee%2Fimage%2Fupload%2Fw_1000%2Cc_fill%2Car_1%3A1%2Cg_auto%2Cr_max%2Fv1681855894%2Finstasize-website%2Flearn%2Fblonde-woman-selfie-instagram-influencer.webp&w=828&q=75') }
